...
CARAVAN_ITEMS = {
    # VIP Points - Updated from table data
    10101007: {"name": "Vip Point +10", "category": "VIP", "description": "10 VIP Points for premium features", "priority": 2},
    10101008: {"name": "Vip Point +100", "category": "VIP", "description": "100 VIP Points for premium features", "priority": 1},
    10101009: {"name": "Vip Point +500", "category": "VIP", "description": "500 VIP Points for premium features", "priority": 1},
    10101010: {"name": "Vip Point +1K", "category": "VIP", "description": "1,000 VIP Points for premium features", "priority": 1},
    10101011: {"name": "Vip Point +5K", "category": "VIP", "description": "5,000 VIP Points for premium features", "priority": 1},
    10101012: {"name": "Vip Point +10K", "category": "VIP", "description": "10,000 VIP Points for premium features", "priority": 1},
    
    # Speedups - General (High Value)
    10103007: {"name": "Speedup 8hour", "category": "Speedups", "description": "8 Hours General Speedup", "priority": 1},
    10103008: {"name": "Speedup 1day", "category": "Speedups", "description": "1 Day General Speedup", "priority": 1},
    10103009: {"name": "Speedup 3days", "category": "Speedups", "description": "3 Days General Speedup", "priority": 1},
    10103010: {"name": "Speedup 7days", "category": "Speedups", "description": "7 Days General Speedup", "priority": 1},
    10103011: {"name": "Speedup 30days", "category": "Speedups", "description": "30 Days General Speedup", "priority": 1},
    
    # Speedups - General (Medium Value)
    10103001: {"name": "Speedup 1min", "category": "Speedups", "description": "1 Minute General Speedup", "priority": 4},
    10103002: {"name": "Speedup 5min", "category": "Speedups", "description": "5 Minutes General Speedup", "priority": 4},
    10103003: {"name": "Speedup 10min", "category": "Speedups", "description": "10 Minutes General Speedup", "priority": 3},
    10103004: {"name": "Speedup 30min", "category": "Speedups", "description": "30 Minutes General Speedup", "priority": 2},
    10103005: {"name": "Speedup 1hour", "category": "Speedups", "description": "1 Hour General Speedup", "priority": 2},
    10103006: {"name": "Speedup 3hour", "category": "Speedups", "description": "3 Hours General Speedup", "priority": 2},
    
    # Speedups - Construction
    10103012: {"name": "Construction Speedup 1min", "category": "Speedups", "description": "1 Minute Construction Speedup", "priority": 4},
    10103013: {"name": "Construction Speedup 5min", "category": "Speedups", "description": "5 Minutes Construction Speedup", "priority": 4},
    10103014: {"name": "Construction Speedup 10min", "category": "Speedups", "description": "10 Minutes Construction Speedup", "priority": 3},
    10103015: {"name": "Construction Speedup 30min", "category": "Speedups", "description": "30 Minutes Construction Speedup", "priority": 3},
    10103016: {"name": "Construction Speedup 1hour", "category": "Speedups", "description": "1 Hour Construction Speedup", "priority": 2},
    10103017: {"name": "Construction Speedup 3hour", "category": "Speedups", "description": "3 Hours Construction Speedup", "priority": 2},
    10103018: {"name": "Construction Speedup 8hour", "category": "Speedups", "description": "8 Hours Construction Speedup", "priority": 1},
    10103019: {"name": "Construction Speedup 1day", "category": "Speedups", "description": "1 Day Construction Speedup", "priority": 1},
    10103020: {"name": "Construction Speedup 3days", "category": "Speedups", "description": "3 Days Construction Speedup", "priority": 1},
    10103021: {"name": "Construction Speedup 7days", "category": "Speedups", "description": "7 Days Construction Speedup", "priority": 1},
    
    # Speedups - Research
    10103022: {"name": "Research Speedup 1min", "category": "Speedups", "description": "1 Minute Research Speedup", "priority": 4},
    10103023: {"name": "Research Speedup 5min", "category": "Speedups", "description": "5 Minutes Research Speedup", "priority": 4},
    10103024: {"name": "Research Speedup 10min", "category": "Speedups", "description": "10 Minutes Research Speedup", "priority": 3},
    10103025: {"name": "Research Speedup 30min", "category": "Speedups", "description": "30 Minutes Research Speedup", "priority": 3},
    10103026: {"name": "Research Speedup 1hour", "category": "Speedups", "description": "1 Hour Research Speedup", "priority": 2},
    10103027: {"name": "Research Speedup 3hour", "category": "Speedups", "description": "3 Hours Research Speedup", "priority": 2},
    10103028: {"name": "Research Speedup 8hour", "category": "Speedups", "description": "8 Hours Research Speedup", "priority": 1},
    10103029: {"name": "Research Speedup 1day", "category": "Speedups", "description": "1 Day Research Speedup", "priority": 1},
    10103030: {"name": "Research Speedup 3days", "category": "Speedups", "description": "3 Days Research Speedup", "priority": 1},
    10103031: {"name": "Research Speedup 7days", "category": "Speedups", "description": "7 Days Research Speedup", "priority": 1},
    
    # Speedups - Training
    10103032: {"name": "Training Speedup 1min", "category": "Speedups", "description": "1 Minute Training Speedup", "priority": 4},
    10103033: {"name": "Training Speedup 5min", "category": "Speedups", "description": "5 Minutes Training Speedup", "priority": 4},
    10103034: {"name": "Training Speedup 10min", "category": "Speedups", "description": "10 Minutes Training Speedup", "priority": 3},
    10103035: {"name": "Training Speedup 30min", "category": "Speedups", "description": "30 Minutes Training Speedup", "priority": 3},
    10103036: {"name": "Training Speedup 1hour", "category": "Speedups", "description": "1 Hour Training Speedup", "priority": 2},
    10103037: {"name": "Training Speedup 3hour", "category": "Speedups", "description": "3 Hours Training Speedup", "priority": 2},
    10103038: {"name": "Training Speedup 8hour", "category": "Speedups", "description": "8 Hours Training Speedup", "priority": 1},
    10103039: {"name": "Training Speedup 1day", "category": "Speedups", "description": "1 Day Training Speedup", "priority": 1},
    10103040: {"name": "Training Speedup 3days", "category": "Speedups", "description": "3 Days Training Speedup", "priority": 1},
    10103041: {"name": "Training Speedup 7days", "category": "Speedups", "description": "7 Days Training Speedup", "priority": 1},
    
    # Speedups - Healing
    10103042: {"name": "Healing Speedup 1min", "category": "Speedups", "description": "1 Minute Healing Speedup", "priority": 4},
    10103043: {"name": "Healing Speedup 5min", "category": "Speedups", "description": "5 Minutes Healing Speedup", "priority": 4},
    10103044: {"name": "Healing Speedup 10min", "category": "Speedups", "description": "10 Minutes Healing Speedup", "priority": 3},
    10103045: {"name": "Healing Speedup 30min", "category": "Speedups", "description": "30 Minutes Healing Speedup", "priority": 3},
    10103046: {"name": "Healing Speedup 1hour", "category": "Speedups", "description": "1 Hour Healing Speedup", "priority": 2},
    10103047: {"name": "Healing Speedup 3hour", "category": "Speedups", "description": "3 Hours Healing Speedup", "priority": 2},
    10103048: {"name": "Healing Speedup 8hour", "category": "Speedups", "description": "8 Hours Healing Speedup", "priority": 1},
    10103049: {"name": "Healing Speedup 1day", "category": "Speedups", "description": "1 Day Healing Speedup", "priority": 1},
    10103050: {"name": "Healing Speedup 3days", "category": "Speedups", "description": "3 Days Healing Speedup", "priority": 1},
    
    # Resources - Food
    10101013: {"name": "Food +1k", "category": "Resources", "description": "1,000 Food", "priority": 4},
    10101014: {"name": "Food +5k", "category": "Resources", "description": "5,000 Food", "priority": 4},
    ...
    10101020: {"name": "Food +5M", "category": "Resources", "description": "5,000,000 Food", "priority": 1},
    10101021: {"name": "Food +10M", "category": "Resources", "description": "10,000,000 Food", "priority": 1},
    10101058: {"name": "Food +50M", "category": "Resources", "description": "50,000,000 Food", "priority": 1},
    10101059: {"name": "Food +100M", "category": "Resources", "description": "100,000,000 Food", "priority": 1},
    
    # Resources - Wood
    10101022: {"name": "Wood +1k", "category": "Resources", "description": "1,000 Wood", "priority": 4},
    10101023: {"name": "Wood +5k", "category": "Resources", "description": "5,000 Wood", "priority": 4},
    10101024: {"name": "Wood +10K", "category": "Resources", "description": "10,000 Wood", "priority": 3},
    10101025: {"name": "Wood +50K", "category": "Resources", "description": "50,000 Wood", "priority": 3},
    10101026: {"name": "Wood +100K", "category": "Resources", "description": "100,000 Wood", "priority": 2},
    10101027: {"name": "Wood +500K", "category": "Resources", "description": "500,000 Wood", "priority": 2},
    10101028: {"name": "Wood +1M", "category": "Resources", "description": "1,000,000 Wood", "priority": 1},
    10101029: {"name": "Wood +5M", "category": "Resources", "description": "5,000,000 Wood", "priority": 1},
    10101030: {"name": "Wood +10M", "category": "Resources", "description": "10,000,000 Wood", "priority": 1},
    10101060: {"name": "Wood +50M", "category": "Resources", "description": "50,000,000 Wood", "priority": 1},
    10101061: {"name": "Wood +100M", "category": "Resources", "description": "100,000,000 Wood", "priority": 1},
    
    # Resources - Stone
    10101031: {"name": "Stone +1k", "category": "Resources", "description": "1,000 Stone", "priority": 4},
    10101032: {"name": "Stone +5k", "category": "Resources", "description": "5,000 Stone", "priority": 4},
    ...
    10101038: {"name": "Stone +5M", "category": "Resources", "description": "5,000,000 Stone", "priority": 1},
    10101039: {"name": "Stone +10M", "category": "Resources", "description": "10,000,000 Stone", "priority": 1},
    10101062: {"name": "Stone +50M", "category": "Resources", "description": "50,000,000 Stone", "priority": 1},
    10101063: {"name": "Stone +100M", "category": "Resources", "description": "100,000,000 Stone", "priority": 1},
    
    # Resources - Gold
    10101040: {"name": "Gold +1k", "category": "Resources", "description": "1,000 Gold", "priority": 4},
    10101041: {"name": "Gold +5k", "category": "Resources", "description": "5,000 Gold", "priority": 4},
    ...
    10101047: {"name": "Gold +5M", "category": "Resources", "description": "5,000,000 Gold", "priority": 1},
    10101048: {"name": "Gold +10M", "category": "Resources", "description": "10,000,000 Gold", "priority": 1},
    10101064: {"name": "Gold +50M", "category": "Resources", "description": "50,000,000 Gold", "priority": 1},
    10101065: {"name": "Gold +100M", "category": "Resources", "description": "100,000,000 Gold", "priority": 1},
    
    # Resources - Silver (New Currency)
    10101066: {"name": "Silver +1k", "category": "Resources", "description": "1,000 Silver", "priority": 4},
    10101067: {"name": "Silver +5k", "category": "Resources", "description": "5,000 Silver", "priority": 4},
    10101068: {"name": "Silver +10K", "category": "Resources", "description": "10,000 Silver", "priority": 3},
    10101069: {"name": "Silver +50K", "category": "Resources", "description": "50,000 Silver", "priority": 3},
    10101070: {"name": "Silver +100K", "category": "Resources", "description": "100,000 Silver", "priority": 2},
    10101071: {"name": "Silver +500K", "category": "Resources", "description": "500,000 Silver", "priority": 2},
    10101072: {"name": "Silver +1M", "category": "Resources", "description": "1,000,000 Silver", "priority": 1},
    10101073: {"name": "Silver +5M", "category": "Resources", "description": "5,000,000 Silver", "priority": 1},
    10101074: {"name": "Silver +10M", "category": "Resources", "description": "10,000,000 Silver", "priority": 1},
    
    
    # Crystal
    10101001: {"name": "Crystal +10", "category": "Crystal", "description": "10 Crystal - Premium Currency", "priority": 3},
    10101002: {"name": "Crystal +100", "category": "Crystal", "description": "100 Crystal - Premium Currency", "priority": 2},
    10101003: {"name": "Crystal +500", "category": "Crystal", "description": "500 Crystal - Premium Currency", "priority": 1},
    10101004: {"name": "Crystal +1k", "category": "Crystal", "description": "1,000 Crystal - Premium Currency", "priority": 1},
    10101005: {"name": "Crystal +5k", "category": "Crystal", "description": "5,000 Crystal - Premium Currency", "priority": 1},
    10101006: {"name": "Crystal +10k", "category": "Crystal", "description": "10,000 Crystal - Premium Currency", "priority": 1},
    
    # Action Points
    10101049: {"name": "Action point refill 10", "category": "Action Points", "description": "10 Action Points", "priority": 3},
    10101050: {"name": "Action point refill 20", "category": "Action Points", "description": "20 Action Points", "priority": 2},
    10101051: {"name": "Action point refill 50", "category": "Action Points", "description": "50 Action Points", "priority": 1},
    10101052: {"name": "Action point refill 100", "category": "Action Points", "description": "100 Action Points", "priority": 1},
    
    # XP Items (New)
    10101053: {"name": "xp +100", "category": "XP", "description": "100 Experience Points", "priority": 3},
    10101054: {"name": "xp +500", "category": "XP", "description": "500 Experience Points", "priority": 2},
    10101055: {"name": "xp +1k", "category": "XP", "description": "1,000 Experience Points", "priority": 2},
    10101056: {"name": "xp +5k", "category": "XP", "description": "5,000 Experience Points", "priority": 1},
    10101057: {"name": "xp +10k", "category": "XP", "description": "10,000 Experience Points", "priority": 1},
    
    # Boosts - Production
    10102001: {"name": "Food boost 8hours", "category": "Boosts", "description": "8 Hour Food Production Boost", "priority": 2},
    10102002: {"name": "Food boost 1day", "category": "Boosts", "description": "1 Day Food Production Boost", "priority": 1},
    10102003: {"name": "Wood boost 8hours", "category": "Boosts", "description": "8 Hour Wood Production Boost", "priority": 2},
    10102004: {"name": "Wood boost 1day", "category": "Boosts", "description": "1 Day Wood Production Boost", "priority": 1},
    10102005: {"name": "Stone boost 8hours", "category": "Boosts", "description": "8 Hour Stone Production Boost", "priority": 2},
    10102006: {"name": "Stone boost 1day", "category": "Boosts", "description": "1 Day Stone Production Boost", "priority": 1},
    10102007: {"name": "Gold boost 8hours", "category": "Boosts", "description": "8 Hour Gold Production Boost", "priority": 2},
    10102008: {"name": "Gold boost 1day", "category": "Boosts", "description": "1 Day Gold Production Boost", "priority": 1},
    
    # Boosts - Advanced Production
    10102030: {"name": "Advanced Food boost 1day", "category": "Boosts", "description": "Advanced 1 Day Food Production Boost", "priority": 1},
    10102031: {"name": "legendary Food boost 1day", "category": "Boosts", "description": "Legendary 1 Day Food Production Boost", "priority": 1},
    10102032: {"name": "Advanced wood boost 1day", "category": "Boosts", "description": "Advanced 1 Day Wood Production Boost", "priority": 1},
    10102033: {"name": "legendary wood boost 1day", "category": "Boosts", "description": "Legendary 1 Day Wood Production Boost", "priority": 1},
    10102034: {"name": "Advanced stone boost 1day", "category": "Boosts", "description": "Advanced 1 Day Stone Production Boost", "priority": 1},
    10102035: {"name": "legendary stone boost 1day", "category": "Boosts", "description": "Legendary 1 Day Stone Production Boost", "priority": 1},
    10102036: {"name": "Advanced gold boost 1day", "category": "Boosts", "description": "Advanced 1 Day Gold Production Boost", "priority": 1},
    10102037: {"name": "legendary gold boost 1day", "category": "Boosts", "description": "Legendary 1 Day Gold Production Boost", "priority": 1},
    
    # Boosts - Gathering
    10102009: {"name": "Gathering boost 8hours", "category": "Boosts", "description": "8 Hour Gathering Speed Boost", "priority": 2},
    10102010: {"name": "Gathering boost 1day", "category": "Boosts", "description": "1 Day Gathering Speed Boost", "priority": 1},
    10102038: {"name": "Advanced gathering boost 1day", "category": "Boosts", "description": "Advanced 1 Day Gathering Speed Boost", "priority": 1},
    10102039: {"name": "legendary gathering boost 1day", "category": "Boosts", "description": "Legendary 1 Day Gathering Speed Boost", "priority": 1},
    
    # Boosts - Military
    10102011: {"name": "March size boost", "category": "Boosts", "description": "March Size Boost", "priority": 2},
    10102012: {"name": "Advanced march size boost", "category": "Boosts", "description": "Advanced March Size Boost", "priority": 1},
    10102013: {"name": "Troop Hp boost", "category": "Boosts", "description": "Troop HP Boost", "priority": 2},
    10102014: {"name": "Advanced Troop Hp boost", "category": "Boosts", "description": "Advanced Troop HP Boost", "priority": 1},
    10102015: {"name": "Troop defense boost", "category": "Boosts", "description": "Troop Defense Boost", "priority": 2},
    10102016: {"name": "Advanced Troop defense boost", "category": "Boosts", "description": "Advanced Troop Defense Boost", "priority": 1},
    10102017: {"name": "Troop attack boost", "category": "Boosts", "description": "Troop Attack Boost", "priority": 2},
    10102018: {"name": "Advanced Troop attack boost", "category": "Boosts", "description": "Advanced Troop Attack Boost", "priority": 1},
    10102019: {"name": "Troop speed boost", "category": "Boosts", "description": "Troop Speed Boost", "priority": 2},
    10102020: {"name": "Advanced Troop speed boost", "category": "Boosts", "description": "Advanced Troop Speed Boost", "priority": 1},
    
    # Boosts - Legendary Military
    10102040: {"name": "legendary March size boost", "category": "Boosts", "description": "Legendary March Size Boost", "priority": 1},
    10102041: {"name": "mythic march size boost", "category": "Boosts", "description": "Mythic March Size Boost", "priority": 1},
    10102042: {"name": "legendary Troop Hp boost", "category": "Boosts", "description": "Legendary Troop HP Boost", "priority": 1},
    10102043: {"name": "mythic Troop Hp boost", "category": "Boosts", "description": "Mythic Troop HP Boost", "priority": 1},
    10102044: {"name": "legendary Troop defense boost", "category": "Boosts", "description": "Legendary Troop Defense Boost", "priority": 1},
    10102045: {"name": "mythic Troop defense boost", "category": "Boosts", "description": "Mythic Troop Defense Boost", "priority": 1},
    10102046: {"name": "legendary Troop attack boost", "category": "Boosts", "description": "Legendary Troop Attack Boost", "priority": 1},
    10102047: {"name": "mythic Troop attack boost", "category": "Boosts", "description": "Mythic Troop Attack Boost", "priority": 1},
    10102048: {"name": "legendary Troop speed boost", "category": "Boosts", "description": "Legendary Troop Speed Boost", "priority": 1},
    10102049: {"name": "mythic Troop speed boost", "category": "Boosts", "description": "Mythic Troop Speed Boost", "priority": 1},
    
    # Boosts - Special
    10102021: {"name": "Anti Spying 8hours", "category": "Boosts", "description": "8 Hour Anti Spying Protection", "priority": 2},
    10102022: {"name": "Anti Spying 1day", "category": "Boosts", "description": "1 Day Anti Spying Protection", "priority": 1},
    10102023: {"name": "Golden hammer 1day", "category": "Boosts", "description": "1 Day Golden Hammer", "priority": 1},
    10102024: {"name": "Golden hammer 3days", "category": "Boosts", "description": "3 Day Golden Hammer", "priority": 1},
    10102025: {"name": "Golden hammer 7days", "category": "Boosts", "description": "7 Day Golden Hammer", "priority": 1},
    10102026: {"name": "Kingdom Shield 8hours", "category": "Boosts", "description": "8 Hour Kingdom Shield", "priority": 2},
    10102027: {"name": "Kingdom Shield 1day", "category": "Boosts", "description": "1 Day Kingdom Shield", "priority": 1},
    10102028: {"name": "Kingdom Shield 7days", "category": "Boosts", "description": "7 Day Kingdom Shield", "priority": 1},
    10102029: {"name": "first aid boost 8hours", "category": "Boosts", "description": "8 Hour First Aid Boost", "priority": 2},
    
    # Teleports
    10104001: {"name": "Random Teleport", "category": "Teleports", "description": "Random Teleport to another location", "priority": 2},
    10104002: {"name": "Advanced Teleport", "category": "Teleports", "description": "Advanced Teleport with more control", "priority": 1},
    10104003: {"name": "Teleport Level1", "category": "Teleports", "description": "Level 1 Teleport", "priority": 3},
    10104004: {"name": "Teleport Level2", "category": "Teleports", "description": "Level 2 Teleport", "priority": 2},
    10104005: {"name": "Teleport Level3", "category": "Teleports", "description": "Level 3 Teleport", "priority": 1},
    
    # Packages & Chests
    10104006: {"name": "Crystal Package 1", "category": "Packages", "description": "Crystal Package Level 1", "priority": 3},
    10104007: {"name": "Crystal Package 2", "category": "Packages", "description": "Crystal Package Level 2", "priority": 2},
    10104008: {"name": "Crystal Package 3", "category": "Packages", "description": "Crystal Package Level 3", "priority": 2},
    10104009: {"name": "Crystal Package 4", "category": "Packages", "description": "Crystal Package Level 4", "priority": 1},
    10104010: {"name": "Crystal Package 5", "category": "Packages", "description": "Crystal Package Level 5", "priority": 1},
    10104011: {"name": "Crystal Package 6", "category": "Packages", "description": "Crystal Package Level 6", "priority": 1},
    ...
    # Support Items
    10104012: {"name": "Construction support 1", "category": "Support", "description": "Construction Support Level 1", "priority": 3},
    10104013: {"name": "Construction support 2", "category": "Support", "description": "Construction Support Level 2", "priority": 3},
    10104014: {"name": "Construction support 3", "category": "Support", "description": "Construction Support Level 3", "priority": 2},
    10104015: {"name": "Construction support 4", "category": "Support", "description": "Construction Support Level 4", "priority": 2},
    10104016: {"name": "Construction support 5", "category": "Support", "description": "Construction Support Level 5", "priority": 1},
    10104017: {"name": "Research support 1", "category": "Support", "description": "Research Support Level 1", "priority": 3},
    10104018: {"name": "Research support 2", "category": "Support", "description": "Research Support Level 2", "priority": 3},
    10104019: {"name": "Research support 3", "category": "Support", "description": "Research Support Level 3", "priority": 2},
    10104020: {"name": "Research support 4", "category": "Support", "description": "Research Support Level 4", "priority": 2},
    10104021: {"name": "Research support 5", "category": "Support", "description": "Research Support Level 5", "priority": 1},
    10104031: {"name": "Training support 1", "category": "Support", "description": "Training Support Level 1", "priority": 3},
    10104032: {"name": "Training support 2", "category": "Support", "description": "Training Support Level 2", "priority": 3},
    10104033: {"name": "Training support 3", "category": "Support", "description": "Training Support Level 3", "priority": 2},
    10104034: {"name": "Training support 4", "category": "Support", "description": "Training Support Level 4", "priority": 2},
    10104035: {"name": "Training support 5", "category": "Support", "description": "Training Support Level 5", "priority": 1},
    
    # Special Items
    10104022: {"name": "Alliance badge", "category": "Special", "description": "Alliance Badge", "priority": 2},
    10104023: {"name": "Piece of lengendary", "category": "Special", "description": "Piece of Legendary Item", "priority": 1},
    10104026: {"name": "Piece of epic", "category": "Special", "description": "Piece of Epic Item", "priority": 2},
    10104027: {"name": "Piece of magic", "category": "Special", "description": "Piece of Magic Item", "priority": 3},
    10104028: {"name": "Piece of normal", "category": "Special", "description": "Piece of Normal Item", "priority": 4},
    10104029: {"name": "Golden pillar", "category": "Special", "description": "Golden Pillar", "priority": 1},
    10104030: {"name": "Change name", "category": "Special", "description": "Name Change Item", "priority": 2},
}
...
ALLIANCE_SHOP_ITEMS = {
    ...
    # Resources - Wood
    10101022: {"name": "Wood +1k", "category": "Resources", "description": "1,000 Wood", "priority": 3},
    10101023: {"name": "Wood +5k", "category": "Resources", "description": "5,000 Wood", "priority": 3},
    10101024: {"name": "Wood +10K", "category": "Resources", "description": "10,000 Wood", "priority": 3},
    10101025: {"name": "Wood +50K", "category": "Resources", "description": "50,000 Wood", "priority": 2},
    10101026: {"name": "Wood +100K", "category": "Resources", "description": "100,000 Wood", "priority": 2},
    10101027: {"name": "Wood +500K", "category": "Resources", "description": "500,000 Wood", "priority": 1},
    10101028: {"name": "Wood +1M", "category": "Resources", "description": "1,000,000 Wood", "priority": 1},
    10101029: {"name": "Wood +5M", "category": "Resources", "description": "5,000,000 Wood", "priority": 1},
    10101030: {"name": "Wood +10M", "category": "Resources", "description": "10,000,000 Wood", "priority": 1},
    ...
    10103002: {"name": "Speedup 5min", "category": "Speedups", "description": "5 Minutes General Speedup", "priority": 4},
    10103003: {"name": "Speedup 10min", "category": "Speedups", "description": "10 Minutes General Speedup", "priority": 3},
    10103004: {"name": "Speedup 30min", "category": "Speedups", "description": "30 Minutes General Speedup", "priority": 3},
    10103005: {"name": "Speedup 1hour", "category": "Speedups", "description": "1 Hour General Speedup", "priority": 2},
    10103006: {"name": "Speedup 3hour", "category": "Speedups", "description": "3 Hours General Speedup", "priority": 2},
    10103007: {"name": "Speedup 8hour", "category": "Speedups", "description": "8 Hours General Speedup", "priority": 1},
    10103008: {"name": "Speedup 1day", "category": "Speedups", "description": "1 Day General Speedup", "priority": 1},
    ...
    10101049: {"name": "Action point refill 10", "category": "Action Points", "description": "10 Action Points", "priority": 3},
    10101050: {"name": "Action point refill 20", "category": "Action Points", "description": "20 Action Points", "priority": 2},
    10101051: {"name": "Action point refill 50", "category": "Action Points", "description": "50 Action Points", "priority": 2},
    10101052: {"name": "Action point refill 100", "category": "Action Points", "description": "100 Action Points", "priority": 1},
